...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[slovak,master,oneside]{ctufit-thesis}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% FILL IN THIS INFORMATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ctufittitle{ScoutPath - aplikácia pre Slovenský skauting} % replace with the title of your thesis
\ctufitauthorfull{Bc. Tomáš Sládek} % replace with your full name (first name(s) and then family name(s) / surname(s)) including academic degrees
\ctufitauthorsurnames{Sládek} % replace with your surname(s) / family name(s)
\ctufitauthorgivennames{Tomáš} % replace with your first name(s) / given name(s)
\ctufitsupervisor{Ing.\,Josef Pavlíček,\,Ph.D.} % replace with name of your supervisor/advisor (include academic degrees)
...
\ctufitabstractCZE{Táto práca sa venuje analýze, návrhu, implementácií a testovania mobilnej aplikácie pre organizáciu progresu členov družiny v rámci programu Slovenského skautingu.}
\ctufitabstractENG{Fill in the abstract of this thesis in English. Lorem ipsum dolor sit amet. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos hymenaeos. Cras pede libero, dapibus nec, pretium sit amet, tempor quis. Sed vel lectus. Donec odio tempus molestie, porttitor ut, iaculis quis, sem. Suspendisse sagittis ultrices augue.}
\ctufitkeywordsCZE{flutter, UI, UX, iOS, Android, skauting}
...
\addbibresource{text/Diplomka.bib}
\usepackage{xurl}
...
\newfontfamily{\materialicons}{MaterialIcons-Regular.ttf}[Ligatures=TeX]

\newcommand{\materialicon}[1]{{\materialicons #1}}
...
\begin{declarationpage}
	Prohlašuji, že jsem předloženou práci vypracoval samostatně a že jsem uvedl veškeré použitéinformační zdroje v souladu s Metodickým pokynem o dodržování etických principů při přípravěvysokoškolských závěrečných prací.
...
\include{text/chapter0_teoria} % include `text.tex' from `text/' subdirectory
\include{text/chapter1_analyza} % include `text.tex' from `text/' subdirectory
\include{text/chapter2_navrh}
\include{text/chapter3_implementacia}
\include{text/chapter4_testovanie}
\include{text/chapter5_zaver}
% \include{text/text} % include `text.tex' from `text/' subdirectory
