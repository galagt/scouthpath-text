...
Posledný vrchol je posledná a záverečná časť skautského chodníka. Predstavuje najväčšiu volňnosť vo výbere úloh z celého skautského chodníka. Obsahom kapitol je podobná Neznámym cestám.

\subsection{Rangerský horizont}
Rangerský horizont sa skladá z troch častí. Osobný rozvoj, rangerský projekt a expedícia. Tieto časti predstavujú zákldaný rámec no ich obsah si ranger volí sám po dohode s vedúcim.
