...
\begin{description}
    ...
    \item[Implementácia] obsahuje vlastnú tvorbu kódu podľa vstupov z predchádzajúcich fázach.
    ...
    \item[Nasadenie] do testovacieho a produkčného prostredia 
    \item[Údržba a podpora]        
\end{description}
