...
\begin{itemize}
    ...
    \item Sledovanie úlohy - \materialicon{explore\_outlined} / \materialicon{explore}
    ...
    \item Prepínanie medzi svetlým a tmavým módom aplikácie - \materialicon{light\_mode} / \materialicon{dark\_mode}
    \item Chybové hlásenie - \materialicon{error\_outline}
    \item Skrývanie kódu radcu - \materialicon{visibility} / \materialicon{visibility\_off}
    \item Oznámenie progresu člena - \materialicon{celebration}
    \item Stiahnutie progresu družiny - \materialicon{file\_download}
\end{itemize}
