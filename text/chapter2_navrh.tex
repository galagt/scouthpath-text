...
\begin{itemize}
    \item Použivateľský profil
    \item Moje úlohy
    \item Moja družina
    \item Program
    \item Hromadné splnenie úlohy
    \item Výber členov družiny
    \item Výber úloh
    \item Sledovanie úlohy
    \item Zrušenie sledovania úlohy
    \item Splnenie úlohy
    \item Čakanie na schválenie úlohy
    \item Splnená úloha
    \item Pridanie úlohy medzi výber
    \item Odstránenie úlohy z výberu
\end{itemize}
